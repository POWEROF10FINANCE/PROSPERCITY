...
import { Home, Landmark, Plane, ShieldAlert, Sparkles, TrendingUp, Lock, ShieldCheck, BookOpen, Upload } from 'lucide-react';
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {locations.map((loc) => {
          const isUnlocked = state.unlockedLocations.includes(loc.path) || 
                             ['home', 'credit', 'library', 'upload'].includes(loc.id);
